...
public class CoralRollers extends SubsystemBase {
  ...
  public CoralRollers() {
    ...
    m_LeftCANrange = new CANrange(CANConstants.LEFT_CAN_RANGE_CORAL, CANConstants.ELEVATOR_CANIVORE);
    m_LeftCANrange.getConfigurator().apply(CANrangeConfiguration);

    m_RightCANrange = new CANrange(CANConstants.RIGHT_CAN_RANGE_CORAL, CANConstants.ELEVATOR_CANIVORE);
