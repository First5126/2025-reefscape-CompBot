...
public class CommandFactory {
  ...
  public Command coralPivotAndIntake(CoralLevels level) {
    ...
    return elevator
        ...
        .andThen(Commands.deadline(Commands.waitSeconds(0.3), m_drivetrain.cardinalMovement(-.25, 0).asProxy()))
  ...
  public Command placeCoralL4Command(){
    Command coralOuttake = m_coralRollers.rollOutCommand(CoralLevels.L4);
