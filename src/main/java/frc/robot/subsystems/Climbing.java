...
public class Climbing extends SubsystemBase {
  ...
  private final DigitalInput m_forwardLimit =
      new DigitalInput(ClimbingConstants.FORWARD_DIGITAL_LIMIT);
  ...
  public Command climb() {
    return run(
        () -> {
          setPosition(ClimbingConstants.ROTATIONS_FOR_CLIMB);
        });
  }
  ...
  public void setPosition(double position) {
    m_leftMotor.setControl(
        m_positionVoltage.withPosition(0).withLimitReverseMotion(m_reverseLimit.get()));
  }
}
