...
public class DrivetrainConstants {
  ...
  public class CurrentLimits {
    ...
    public static final Current kDriveCurrentLimitMin =
        Amps.of(40); // Motor drops to min after hitting ma
    public static final Time kDriveCurrentDuration =
        Seconds.of(0.25); // Time to hold at min current
  }
}
