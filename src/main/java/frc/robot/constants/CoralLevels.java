...
public enum CoralLevels {
  L1(0.0, 1, -8.0, 5),
  L2(1.30, 1, -8.0, 3.5),
  L3(2.8163769531249996, 1, -8.0, 3.5),
  L4(4.99, 1, -8.0, 3.5),
  CORAL_STATION(0.914795, 1, 7.0, 74.5),
  CORAL_STATION_OUT(0.914795, 1, -5.0, 74.5);
  ...
  private CoralLevels(double height, double distance, Double volts, double angle) {
